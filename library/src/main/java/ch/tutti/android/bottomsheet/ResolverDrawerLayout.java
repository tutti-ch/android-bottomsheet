...
public class ResolverDrawerLayout extends ViewGroup {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                boolean isSlidingUp = Math.abs(dy) > mTouchSlop
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        return handled
                || (action == MotionEvent.ACTION_MOVE && mCollapseOffset > 0);
    }
    ...
    public void setScrollableChildView(View scrollableChildView) {
        mScrollableChildView = scrollableChildView;
    }
